...
export class Event extends React.Component<IEventProps, IEventState> {
  ...
  public constructor(props) {
    ...
    this.onChangeEventLocationArea=this.onChangeEventLocationArea.bind(this);
  ...
  private async onSave() {
    ...
    eventData.location = this.state.eventData.locationArea;
  ...
  private onChangeEventLocationArea (event:any) {
    const eventLocationArea = event.target.value;
    this.setState({eventData: {...this.state.eventData, locationArea: eventLocationArea}});
  }
            ...
            }
            {
              ...
              <div>
                ...
                <div>
                  <TextField
                      label={strings.LocationTextLabel}
                      value={this.state.eventData ? this.state.eventData.locationArea : ''}
                      onChange={this.onChangeEventLocationArea}
                      //onGetErrorMessage={this.onGetErrorMessageTitle}
                      //deferredValidationTime={500}
                      multiline
                      disabled={this.state.userPermissions.hasPermissionAdd || this.state.userPermissions.hasPermissionEdit ? false : true}
